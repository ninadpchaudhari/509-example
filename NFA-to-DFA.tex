...
We can find the complement of the DFA drawn above \ref{fig:dfa} by flipping the accepting to non-accepting states and vice-versa to obtain Fig \ref{fig:comp_dfa}

$$
D_1' = (\{d_0', d_1', d_2', d_3'\}, \{a,b\}, \delta, d_0', \{d_3'\})
$$
where $\delta$ is defined as:
\begin{tabular}{|l|l|l|}
\hline
